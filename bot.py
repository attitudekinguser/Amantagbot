...
client.run_until_disconnected()#Copyright @kabeerxcode
#sys
import os, logging, asyncio
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('🙃 Add To Group', 'http://t.me/TaG_X_Bot?startgroup=true'),
                       Button.url('🙄Support', 'https://t.me/english_hindi_chatting_group_ind'),
...
print("~~~~Started~~~~~")
print("¯\_(ツ)_/¯ Need Help Join @english_hindi_chatting_group_ind )
